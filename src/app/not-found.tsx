...
import { HOME_ROUTE, HOME_SERVICES_SECTION, STORE_ROUTE } from "@/lib/routes";
      ...
      <div className="min-h-screen bg-linear-to-b from-background to-muted/30 flex items-center justify-center px-4">
        <div className="text-center max-w-lg">
          ...
          <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
            Oops! It seems this page has gone missing. Don't worry, let's get
            you back on track to your perfect smile.
          </p>
          ...
          <p className="mt-12 text-sm text-muted-foreground">
            ...
            <a
              onClick={() => scrollToSection(STORE_ROUTE)}
        ...
        <p className="mt-12 text-sm text-muted-foreground">
          ...
          or{" "}
          <a
            onClick={() => scrollToSection(HOME_SERVICES_SECTION)}
            className="text-primary hover:underline cursor-pointer"
          >
            Services
          </a>
