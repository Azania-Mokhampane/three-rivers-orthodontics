          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                At Three Rivers Orthodontics, we are committed to protecting
            ...
            <section className="mb-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                encryption, secure servers, and restricted access to personal
                data.
              </p>
            </section>
            ...
            <section className="mb-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                preferences. Disabling cookies may affect some functionality of
                our website.
              </p>
            </section>
            ...
            <section className="mb-10 p-6 bg-primary/5 rounded-xl border border-primary/10">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                under POPIA, we ensure that your personal information is
                processed lawfully, minimally, and securely.
              </p>
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-6">
                <li>
                  The right to be notified when your personal information is
                  being collected
                </li>
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-6">
                ...
                <li>
                  <strong>Information quality:</strong> We ensure your
                ...
                <li>
                  <strong>Data subject participation:</strong> You can access
