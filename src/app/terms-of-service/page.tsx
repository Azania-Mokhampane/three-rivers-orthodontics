        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              any appointment cancellations or rescheduling. Missed appointments
              without prior notice may be subject to a cancellation fee.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              We reserve the right to reschedule appointments due to unforeseen
              circumstances and will provide as much notice as possible.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              alternative arrangements have been made. We offer various payment
              options including:
            </p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
          ...
          <section className="mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              purchase with proof of purchase. Opened or used products cannot be
          ...
          <section className="mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              results may vary. We are not liable for outcomes that result from
              failure to follow treatment instructions or recommended care
              guidelines.
            </p>
          </section>
